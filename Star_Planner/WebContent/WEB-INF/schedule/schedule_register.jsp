		...
		<table>
			...
			<tr>
				<td align="center" colspan="2">
					<button type="submit" style="background: url('/Star_Planner/img/btn_register.png') center; width: 78px; height: 30px; background-repeat: no-repeat; border-radius: 5px; margin-right: 80px;"></button>
